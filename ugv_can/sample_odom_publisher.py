...
class OdomPublisher(Node):
    def __init__(self):
        ...
        self.pose_y = 0.0
        self.pose_theta = 0.0
        self.wheelbase = 1.65  # Example value, adjust based on your robot's configuration
        self.steer_ratio = 0.5  # Example value, adjust based on your robot's configuration
        self.linear_velocity = 0.1  # Linear velocity in m/s
        self.steering_angle = 0.52  # Initial steering angle in radians
